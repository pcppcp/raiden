...
class Discovery(ContractProxy):
    ...
    def endpoint_by_address(self, node_address_bin):
        ...
        endpoint = self.contract.functions.findEndpointByAddress(
            node_address_hex
        ).call()
    ...
    def address_by_endpoint(self, endpoint):
        address = self.contract.functions.findAddressByEndpoint(endpoint).call()
